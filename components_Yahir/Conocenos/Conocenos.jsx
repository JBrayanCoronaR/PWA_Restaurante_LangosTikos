    ...
    return (
        <div className="conocenos-container">
            ...
            <section className="section">
                ...
                <hr className="linea-horizontal" />
                <p className="texto-seccion">Ofrecer a nuestros clientes una experiencia culinaria 
                    excepcional, con platos frescos y auténticos de mar, elaborados con ingredientes
                     de la más alta calidad. Nos comprometemos a brindar un ambiente acogedor y un servicio amable, 
                     donde cada visita sea una celebración de los sabores del océano.</p>
            </section>
            ...
            <section className="section">
                ...
                <hr className="linea-horizontal" />
                <p className="texto-seccion">Ser el restaurante de comida del mar más querido en nuestro estado, 
                    reconocido por nuestra dedicación a la frescura, la innovación en nuestros platillos y el 
                    compromiso con la sostenibilidad. Buscamos expandir nuestra huella, ofreciendo un espacio 
                    donde la comunidad y los amantes de la gastronomía se reúnan para disfrutar de lo mejor del mar.</p>
            </section>
